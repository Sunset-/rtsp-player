...
window.$tip = window.notify = window.$notify = (function() {
  var $el = $(
    '<div class="global-tip"><i class="xui_message-img iconfont"></i><span></span></div>'
  );
  $el.appendTo("body");
  var $span = $("span", $el);
  var $icon = $("i", $el);
  ...
  function generateConfirmEl() {
    ...
    wrap.innerHTML = `
		<div class="global-confirm-box">
			...
			<footer>
				<button class="xui-btn xui-btn-style xui-btn-small xui-btn-primary global-confirm-ensure">确定</button>
				<button class="xui-btn xui-btn-style xui-btn-small xui-btn-default global-confirm-cancel">取消</button>
			</footer>
		</div>
